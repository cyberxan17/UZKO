...
import { Banknote, Plus, Minus, CreditCard, DollarSign, Tag, Lock, Send, Trash2, ChevronDown, Search, UserRound, ReceiptText } from "lucide-react";
import {
...
export function KassadanPulChiqarish() {
  ...
  const submit = () => {
    if (!code) { toast.error("Tasdiqlash kodi kerak"); return; }
    ...
    setNote(""); setCode(""); setAgentId(""); setEmployeeId(""); setEmployeeQuery("");
  };
          ...
          <div className="grid min-h-0 content-start gap-3">
            ...
            <div className="rounded-lg border bg-card p-3">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={submit} className="shrink-0 gap-2 px-3">
