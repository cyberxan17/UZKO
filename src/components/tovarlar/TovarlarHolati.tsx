...
function categorize(stats: Stat[]) {
...
export function TovarlarHolati() {
  ...
  const cats = React.useMemo(() => categorize(stats), [stats]);
      ...
      <div className="border-b bg-card/50 px-2.5 py-2">
        ...
        <div className="mt-1.5 grid grid-cols-2 gap-1.5 text-xs">
          <div className="rounded bg-card/70 px-1.5 py-1">
            <span className="text-muted-foreground">Jami son: </span>
            <b className="tabular-nums">{totals.qty}</b>
          </div>
          <div className="rounded bg-card/70 px-1.5 py-1">
          ...
          <div className="flex h-full min-h-0 flex-col gap-1.5">
            ...
            {items.map((stat, index) => (
              ...
              >
                ...
                <span className="text-right font-bold tabular-nums">{stat.qty}</span>
