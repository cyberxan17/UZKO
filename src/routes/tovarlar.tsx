...
import { Package, History, RotateCcw, Plus } from "lucide-react";
...
const TABS = [
  ...
  { id: "qaytarish", labelKey: "Tovar qaytarish", icon: RotateCcw },
  { id: "tarix",  labelKey: "products_history", icon: History },
] as const;

type Tab = (typeof TABS)[number]["id"];
export type ProductCreateMode = "yangi" | "xarid" | "baza";
